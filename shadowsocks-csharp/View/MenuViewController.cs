...
public class MenuViewController
{
    ...
    private void controller_Errored(Exception ex)
    {
    ...
    private void controller_FileReadyToOpen(string path)
    {
    ...
    private void controller_UpdatePACFromGFWListError(Exception ex)
    {
        ShowBalloonTip(I18N.GetString("Failed to update PAC file"), ex.Message, ToolTipIcon.Error, 5000);
        Logging.LogUsefulException(ex);
    }

    private void controller_UpdatePACFromGFWListCompleted(GFWListUpdater updater, bool success)
    {
        var result = success ?
    ...
    private void updateFreeNodeChecker_NewFreeNodeFound()
    {
        if (configfrom_open)
        {
            eventList++;
    ...
    private void updateChecker_NewVersionFound()
    {
