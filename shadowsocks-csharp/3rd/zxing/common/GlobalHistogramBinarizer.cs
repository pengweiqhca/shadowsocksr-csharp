...
public class GlobalHistogramBinarizer : Binarizer
{
    ...
    public override BitArray getBlackRow(int y, BitArray row)
    {
        ...
        if (!estimateBlackPoint(localBuckets, out var blackPoint))
            return null;
    ...
    /// </returns>
    public override Binarizer createBinarizer(LuminanceSource source) => new GlobalHistogramBinarizer(source);
