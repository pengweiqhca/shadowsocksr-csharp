...
namespace ZXing.Common.ReedSolomon
{
    ...
    {
        public static GenericGF AZTEC_DATA_12 = new(0x1069, 4096, 1); // x^12 + x^6 + x^5 + x^3 + 1
        public static GenericGF AZTEC_DATA_10 = new(0x409, 1024, 1); // x^10 + x^3 + 1
        public static GenericGF AZTEC_DATA_6 = new(0x43, 64, 1); // x^6 + x + 1
        public static GenericGF AZTEC_PARAM = new(0x13, 16, 1); // x^4 + x + 1
        public static GenericGF QR_CODE_FIELD_256 = new(0x011D, 256, 0); // x^8 + x^4 + x^3 + x^2 + 1
        public static GenericGF DATA_MATRIX_FIELD_256 = new(0x012D, 256, 1); // x^8 + x^5 + x^3 + x^2 + 1
        ...
        /// </returns>
        public override string ToString() => $"GF(0x{primitive:X},{size})";
    }
}