...
public abstract class GridSampler
{
    ...
    {
        gridSampler = newGridSampler ?? throw new ArgumentException();
    }
    ...
    public virtual BitMatrix sampleGrid(BitMatrix image, int dimensionX, int dimensionY, PerspectiveTransform transform) => throw new NotSupportedException();
