...
namespace ZXing.Common
{
    ...
    public sealed class HybridBinarizer : GlobalHistogramBinarizer
    {
        ...
        public override Binarizer createBinarizer(LuminanceSource source) => new HybridBinarizer(source);
        ...
        private static int cap(int value, int min, int max) => value < min ? min : value > max ? max : value;
        ...
        {
            var blackPoints = new int[subHeight][];
