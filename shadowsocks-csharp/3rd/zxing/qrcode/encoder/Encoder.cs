...
namespace ZXing.QrCode.Internal
{
    ...
    public static class Encoder
    {
        ...
        public static QRCode encode(string content, ErrorCorrectionLevel ecLevel) => encode(content, ecLevel, null);
                                  ...
                                  IDictionary<EncodeHintType, object> hints)
        {
            ...
            var encoding = (hints == null || !hints.ContainsKey(EncodeHintType.CHARACTER_SET) ? null : (string)hints[EncodeHintType.CHARACTER_SET]) ?? DEFAULT_BYTE_MODE_ENCODING;
        ...
        /// <returns></returns>
        private static Mode chooseMode(string content, string encoding) => Mode.BYTE;
