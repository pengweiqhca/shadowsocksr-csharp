...
internal sealed class FormatInformation
{
    ...
    private static readonly int[][] FORMAT_INFO_DECODE_LOOKUP = new[]
    {
        new [] { 0x5412, 0x00 },
        new [] { 0x5125, 0x01 },
        new [] { 0x5E7C, 0x02 },
    ...
    public override int GetHashCode() => errorCorrectionLevel.ordinal() << 3 | dataMask;

    public override bool Equals(object o)
    {
        if (o is not FormatInformation other)
        {
            return false;
        }
