...
namespace ZXing.QrCode.Internal
{
    ...
    public sealed class Version
    {
        ...
        public sealed class ECBlocks
        {
            ...
            {
                get => ecCodewordsPerBlock * NumBlocks;
            }
        ...
        /// </returns>
        public override string ToString() => Convert.ToString(versionNumber);

        /// <summary> See ISO 18004:2006 6.5.1 Table 9</summary>
        private static Version[] buildVersions() => new Version[]
        {
            ...
            new(11, new[]
                ...
                new ECBlocks(30, new ECB(1, 50), new ECB(4, 51)), new ECBlocks(28, new ECB(4, 22), new ECB(4, 23)), new ECBlocks(24, new ECB(3, 12), new ECB(8, 13))),
            new(12, new[]
            {
                6, 32, 58
            ...
            {
                6, 30, 58, 86
            }, new ECBlocks(28, new ECB(3, 113), new ECB(4, 114)), new ECBlocks(26, new ECB(3, 44), new ECB(11, 45)), new ECBlocks(26, new ECB(17, 21),
                new ECB(4, 22)), new ECBlocks(26, new ECB(9, 13), new ECB(16, 14))),
            new(20, new[]
            {
                6, 34, 62, 90
            ...
            {
                6, 34, 62, 90, 118
            }, new ECBlocks(30, new ECB(8, 122), new ECB(4, 123)), new ECBlocks(28, new ECB(22, 45), new ECB(3, 46)), new ECBlocks(30, new ECB(8, 23), new ECB(26, 24)), new ECBlocks(30, new ECB(12, 15),
                new ECB(28, 16))),
            new(28, new[]
            {
                6, 26, 50, 74, 98, 122
            ...
            }, new ECBlocks(30, new ECB(12, 121), new ECB(7, 122)), new ECBlocks(28, new ECB(12, 47), new ECB(26, 48)), new ECBlocks(30, new ECB(39, 24), new
                ECB(14, 25)), new ECBlocks(30, new ECB(22, 15), new ECB(41, 16))),
            new(36, new[]
            {
