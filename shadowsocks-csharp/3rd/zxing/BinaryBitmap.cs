...
namespace ZXing
{
    ...
    public sealed class BinaryBitmap
    {
        ...
        public BinaryBitmap(Binarizer binarizer) => this.binarizer = binarizer ?? throw new ArgumentException("Binarizer must be non-null.");
        ...
        {
            get => matrix ??= binarizer.BlackMatrix;
        }
        ...
        {
            get => binarizer.LuminanceSource.CropSupported;
        }
        ...
        {
            get => binarizer.LuminanceSource.RotateSupported;
        }
        ...
        {
            var newSource = binarizer.LuminanceSource.rotateCounterClockwise45();
            return new BinaryBitmap(binarizer.createBinarizer(newSource));
        }
